...
class ScraperBot(Thread):
    ...
    def __createFilename(self, base, label, citations_start, citations_stop, extension):
        return base + "_" + label + "_" + str(self.pages) + "_" + str(citations_start) + "-" + str(citations_stop) + "." + extension
    ...
    def __downloadPage(self, url):
        try:
            ...
            wx.CallAfter(pub.sendMessage, 'updateInfo', info)
    ...
    def __makeSoup(self, baseurl, num):
        ...
        if num == self.pages:
            ...
            wx.CallAfter(pub.sendMessage, 'updateInfo', info)
            wx.CallAfter(pub.sendMessage, 'enableButton', True)
...
class ScraperPanel(wx.Panel):
    ...
    def InitGUI(self):
        ...
        pub.subscribe(self.updateInfo, 'updateInfo')
        pub.subscribe(self.enableButton, 'enableButton')
    ...
    def OnScraperButtonClicked(self, event):
        wx.CallAfter(pub.sendMessage, 'enableButton', False)
